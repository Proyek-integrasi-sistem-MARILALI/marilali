...
class Accommodation(Base):
    """Planned accommodation details within an itinerary for trip planning."""
...
class Flight(Base):
    """Planned flight details within an itinerary for trip planning."""
...
class Transportation(Base):
    """
    Planned transportation between locations within an itinerary.
    For trip planning of inter-city or local transportation (car, bus, train, boat, etc.).
    This is for planning purposes only - not for booking.
    """
