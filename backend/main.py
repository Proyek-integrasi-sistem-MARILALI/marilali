...
from services.favorite_itinerary.router import router as favorite_itinerary_router
...
app.include_router(favorite_itinerary_router, prefix="/favorites/itineraries", tags=["Favorite Itineraries"])
